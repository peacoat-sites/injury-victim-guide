...
slug: "average-slip-and-fall-settlement-at-grocery-store"
...
Nobody publishes a clean "average grocery store slip and fall settlement" with reliable methodology, because most settlements are confidential. What exists is verdict data from cases that went to trial, which skews higher than settled cases (people generally don't take weak cases to trial). Nolo's personal injury resources explain clearly that the wide variance in outcomes makes any "average" figure nearly meaningless without case-specific analysis.

Here's my honest take, based on years of claim files: minor injuries with clean liability typically resolve in the $10,000 to $30,000 range. Moderate injuries (a fracture, a soft tissue injury requiring significant treatment) with solid notice evidence often land between $40,000 and $150,000. Serious or permanent injuries with good liability facts can go substantially higher, and cases with catastrophic outcomes or particularly egregious negligence have resolved for seven figures.
...
If you're building your case right now, one of the most practical things you can do is start a detailed injury journal documenting your symptoms, limitations, and daily impact from day one. Something like a [medical and injury documentation journal](https://www.amazon.com/s?k=injury+documentation+journal) (the site may earn a commission on purchases) gives you a contemporaneous record that's genuinely useful if your case ever requires it. Adjusters notice when plaintiffs have organized, consistent documentation. It signals they're serious.

The grocery store's insurer is prepared. Being prepared yourself is the only real equalizer.
