...
slug: "what-to-do-after-a-rear-end-collision-not-at-fault"
affiliate_disclosure: true
faqs:
  - q: "Do I have to use the at-fault driver's insurance, or can I use my own?"
    a: "You can use either, and sometimes it makes sense to use both for different parts of the claim. Many people file a third-party claim with the at-fault driver's insurer for both vehicle damage and injuries. But if the at-fault insurer is slow, disputes liability, or the other driver was uninsured, your own collision and uninsured/underinsured motorist coverage can step in. Your insurer may then seek reimbursement from the at-fault party later through a process called subrogation."
  - q: "Will my insurance rates go up if I report a not-at-fault accident?"
    a: "They shouldn't, and in many states there are laws that prohibit rate increases for not-at-fault accidents. That said, rate-setting is complex and varies by insurer and state, so it's worth asking your agent directly before you assume."
  - q: "What if the other driver claims the accident was my fault?"
    a: "This is why the police report and your own photos are so important. Rear-end collisions are presumptively the following driver's fault in most states, though that presumption can be rebutted in certain situations. If liability is disputed, having a police report, witness contact information, and ideally dashcam footage puts you in a much stronger position."
...
Keep a pain journal starting that night. Nothing fancy, a notes app on your phone works. Date, time, what hurts, scale of 1-10, how it affected your day. I've recommended [this kind of personal injury documentation journal](https://www.amazon.com/s?k=personal+injury+documentation+journal) to people for years. (The site may earn a small commission on purchases.) It sounds tedious, but a consistent daily record of your pain and limitations is worth real money in a settlement because it shows impact on your life, not just a list of doctor visits.
...
- [Guided Medical Symptom Journal and Pain Tracker](https://www.amazon.com/dp/B08CZL6T9K?tag=contentportfo-20)
- [this kind of personal injury documentation journal](https://www.amazon.com/s?k=personal+injury+documentation+journal)
- [insurance claim workbooks and organizers](https://www.amazon.com/s?k=insurance+claim+organizer+workbook)
- [Smead Accordion Expanding File Folder for Legal Files](https://www.amazon.com/dp/B00L1JXTSK?tag=contentportfo-20)
- [Nolo's Plain-English Law Dictionary](https://www.amazon.com/dp/1413328851?tag=contentportfo-20)
