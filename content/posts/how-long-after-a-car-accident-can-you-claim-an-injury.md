---
title: "Car Accident Injury Claims: How Long Do You Have?"
date: 2026-07-22T12:49:32.817672+00:00
draft: false
description: "Learn the deadline for filing injury claims after a car accident, state limits, and why acting quickly protects your case."
image: "/img/heroes/35784044.jpg"
categories: ["State Laws and Deadlines"]
tags: ["long", "after", "accident", "claim", "injury"]
...
slug: "how-long-after-a-car-accident-can-you-claim-an-injury"
affiliate_disclosure: true
faqs:
  - q: "Can I still file a claim if I didn't feel hurt at the scene?"
    a: "Yes, absolutely. Delayed symptom onset is medically documented and legally recognized. What matters is that you report the accident promptly to your insurer and see a doctor as soon as symptoms appear, creating a clear paper trail connecting your injury to the crash."
  - q: "What happens if I miss the statute of limitations deadline?"
    a: "In almost all cases, your claim is permanently barred. Courts rarely make exceptions for people who simply didn't file in time. If you're close to a deadline and unsure, consult a personal injury attorney immediately, most will tell you within a free consultation whether you still have time."
  - q: "Does filing an insurance claim start the statute of limitations clock?"
    a: "No. The statute of limitations for filing a lawsuit runs from the date of the accident (or the date of injury discovery, in applicable states), regardless of whether you've filed an insurance claim. These are separate processes on separate timelines."
  - q: "How long does the other driver's insurance have to settle my claim?"
    a: "This varies by state. Many states have fair claims settlement laws requiring insurers to acknowledge claims within 10 days and make coverage decisions within 30 to 45 days. California requires acceptance or denial within 40 days of receiving proof of claim. Delays beyond those windows may constitute bad faith."
  - q: "If I was a passenger in someone else's car, does this affect my deadline?"
    a: "The statute of limitations applies the same way to passengers as to drivers. You have a claim against the at-fault driver (and potentially your friend's insurer, depending on the policy) and the same deadlines apply. Being a passenger doesn't extend or shorten your window."
---

Three years. That's how long a woman I'll call Dana had to file her [injury claim](/what-is-a-personal-injury-claim/), and she came within six weeks of missing the deadline, not because she was being lazy, but because her back pain didn't really show up until eight months after the crash. She assumed that meant she'd waited too long. She almost walked away from a legitimate claim worth tens of thousands of dollars.

Please don't be Dana.

The question of how long you have to claim an injury after a [car accident](/car-accident-injury-claim-denied-what-to-do/) is one I fielded constantly as an adjuster, and now I hear it from the other side of the table. The honest answer is: it depends on where you live, what kind of claim you're filing, and a handful of timing rules that most people have completely wrong. I'm going to untangle all of it.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Most states give you 2-3 years from the accident date to file a personal injury lawsuit, but deadlines vary from 1-6 years.</li><li style="margin:5px 0">Your insurance claim deadline is often much shorter, sometimes just 30-90 days, and is set by your policy, not state law.</li><li style="margin:5px 0">Injuries that appear weeks or months later (like herniated discs) are still claimable, but documentation timing matters enormously.</li><li style="margin:5px 0">Missing your state's statute of limitations almost always kills your case permanently, with very few exceptions.</li><li style="margin:5px 0">Reporting the accident to your insurer immediately is always the right call, even if you feel fine at the scene.</li></ul></div>
...
| State | Injury Claim Deadline | Property Damage Deadline | Notes |
|---|---|---|---|
| California | 2 years | 3 years | Discovery rule applies |
| Florida | 2 years (reduced from 4 in 2023) | 4 years | Major recent change |
| Texas | 2 years | 2 years | Strict; few exceptions |
| New York | 3 years | 3 years | 90-day notice for govt vehicles |
| Illinois | 2 years | 5 years | |
| Pennsylvania | 2 years | 2 years | |
| Ohio | 2 years | 2 years | |
| Georgia | 2 years | 4 years | |
| Michigan | 3 years | 3 years | No-fault state; different rules |
| Colorado | 3 years | 3 years | |
| New Jersey | 2 years | 6 years | No-fault PIP rules apply |
| Arizona | 2 years | 2 years | |
| Minnesota | 2 years | 6 years | No-fault state |
| Louisiana | 1 year | 1 year | Shortest in the country |
...
Keep an injury journal. One reader who emailed me last spring mentioned she'd started a simple notebook the week after her crash: date, symptoms, how they affected her day. That journal became a key piece of her pain-and-suffering documentation. Something like the [Accident and Injury Documentation Journal](https://www.amazon.com/s?k=accident+injury+documentation+journal) on Amazon (the site may earn a commission) can keep this organized if a blank notebook feels too unstructured.
...
- [Insurance Information Institute (iii.org)](https://www.iii.org/): Industry data on auto claims, coverage requirements, and policyholder rights
- [CDC WISQARS Injury Data](https://www.cdc.gov/injury/wisqars/): National injury statistics including motor vehicle crash outcomes and delayed presentations
