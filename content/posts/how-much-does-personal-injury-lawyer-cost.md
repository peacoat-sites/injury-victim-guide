...
slug: "how-much-does-personal-injury-lawyer-cost"
affiliate_disclosure: true
faqs:
  - q: "Do I have to pay a personal injury lawyer if I lose my case?"
    a: "Under a standard contingency fee agreement, no. If there's no recovery, there's no attorney fee. You may still owe case costs depending on your agreement, so ask your attorney how that's handled upfront before signing."
  - q: "Can I negotiate the contingency fee percentage?"
    a: "Yes, and more people should try. Attorneys set their rates, but they're not immovable. On strong cases with clear liability and high damages, an attorney may accept a lower percentage because the risk is lower. It's a legitimate conversation to have."
  - q: "What's the average personal injury settlement amount?"
    a: "This varies too widely to give a useful 'average.' It depends on injury severity, liability, jurisdiction, insurance policy limits, and whether the case goes to trial. Anyone quoting you a typical number without knowing your facts is guessing."
  - q: "Are there any upfront costs at all?"
...
The contingency percentage isn't the only number you need to understand. There are case costs, and this is where things get a little more complicated.
...
**Option A (fees calculated first):**
$100,000 x 33% = $33,000 in fees. Then $5,000 in costs. You receive $62,000.

**Option B (costs deducted first):**
$100,000 minus $5,000 = $95,000. Then 33% of $95,000 = $31,350 in fees. You receive $63,650.
...
**Scenario 1: Minor car accident, whiplash, clear fault**
Claimant had $8,500 in medical bills, missed two weeks of work. Tried to settle directly with the insurer and was offered $12,000. Attorney took the case on 33% contingency, negotiated to $31,000, case costs of $800. Net to client after fees and costs: approximately $19,900. The "free" DIY path would have cost her $7,900 in real money.

**Scenario 2: Slip and fall with disputed liability**
Client fell on a wet grocery store floor, broke his wrist, required surgery. Disputed liability made this a real fight. Attorney's fee moved to 40% because it required depositions and expert testimony. Settlement: $95,000. Case costs: $6,200. Net to client: approximately $50,800. The store's initial offer was $18,000.

**Scenario 3: Workers' comp in a fee-capped state**
Client suffered a serious back injury, state law capped attorney fees at 15% of the award. Award came in at $62,000. Attorney fee: $9,300. Client kept $52,700. The cap protected the client meaningfully, though the attorney put in substantial work for that fee.
...
- [Insurance Information Institute (iii.org)](https://www.iii.org/): Industry data on insurance claims, consumer rights, and settlement processes.
- [American Bar Association Model Rules of Professional Conduct](https://www.americanbar.org/groups/public_education/): Governs attorney fee agreements, contingency structures, and disclosure requirements.
- [National Center for State Courts](https://www.ncsc.org/): Data on civil case timelines and litigation costs across jurisdictions.
...
*Photo: [August de Richelieu](https://www.pexels.com/@august-de-richelieu) via Pexels*
