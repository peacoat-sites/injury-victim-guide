...
faqs:
  - q: "How long do I have to file a catastrophic injury lawsuit?"
    a: "This is called the statute of limitations, and it varies by state. Most states set a two to three year window from the date of injury. Miss it and you lose your right to sue entirely, regardless of how strong your case is. Some exceptions apply, particularly for victims who were minors at the time of injury or for cases where the injury's cause wasn't immediately known. Don't guess. Get a consultation before you assume you have time."
  - q: "Can I still sue if I was partially at fault for the accident?"
    a: "In most states, yes. The legal standard is either 'comparative negligence' or 'contributory negligence' depending on where you are. Under comparative negligence, which most states use in some form, your damages get reduced by your percentage of fault. If you're found 20% responsible and damages total $1 million, you'd receive $800,000. A few states still use contributory negligence, which bars recovery entirely if you're even 1% at fault. Again, your state's rules matter enormously here."
  - q: "What if the at-fault party doesn't have enough insurance?"
    a: "This is genuinely one of the hardest situations in catastrophic injury cases. A few options exist. If the defendant has personal assets beyond their policy limits, your attorney can pursue those directly. Your own underinsured motorist coverage, if you have it, may provide additional compensation in car accident cases. If multiple parties share liability, each may have their own coverage. In some cases, bankruptcy proceedings intersect with injury claims. There's rarely a clean solution when coverage is inadequate, which is exactly why reviewing your own insurance coverage before a crisis happ"
  - q: "What does a catastrophic injury attorney actually cost?"
...
A catastrophic injury, by most legal and medical definitions, is one that permanently prevents the victim from performing any gainful work, or one that results in permanent severe impairment. Spinal cord injuries, amputations, severe traumatic brain injuries, severe burns covering major body surface area, and loss of sight or hearing typically qualify. The [CDC's injury data](https://www.cdc.gov/injury/wisqars/) shows that traumatic brain injuries and spinal cord injuries together account for hundreds of thousands of emergency hospitalizations every year, with lifetime care costs that routinely reach into the millions.

That cost reality is exactly why these cases are fought so hard by insurance companies. More money on the table means more resistance on their side. Every tactic I saw used during my years as an adjuster gets deployed harder and faster in catastrophic cases.
...
Here's a straight-line view of what actually happens, without the glossy brochure version.

**Step 1: Secure immediate medical documentation.**
Everything starts with the medical record. Get copies of every ER note, imaging report, surgical record, and physician assessment from day one. Don't wait until you've hired an attorney. Start a dedicated folder, physical or digital, right now. An [injury documentation journal](https://www.amazon.com/s?k=injury+documentation+journal) can help you track symptoms, treatments, and daily limitations in your own words, which becomes valuable evidence later. (This site may earn a commission from qualifying purchases.)

**Step 2: Preserve all evidence.**
Photographs of the scene, damaged vehicles, defective equipment, or injury progression. Witness names and contact information. Incident reports. Surveillance footage, if any exists, which can disappear fast if you don't request it in writing quickly.

**Step 3: Do not give a recorded statement to the opposing insurer.**
I can't stress this enough. The adjuster asking for a "quick recorded statement" is not doing you a favor. Anything you say can and will be used to reduce your payout. You have no obligation to give one before you've consulted an attorney.
...
Filing puts the case into the formal legal system and starts the clock on discovery, depositions, and ultimately trial. Most cases settle before trial, but you have to be willing to go all the way, and the other side has to know you're willing.
...
Most experienced attorneys in this space won't recommend settlement until the client has reached what's called "maximum medical improvement," meaning the doctors can say with reasonable confidence what the permanent condition is. That's not pessimism. That's how you get the math right.
...
[Nolo's personal injury resources](https://www.nolo.com/legal-encyclopedia/personal-injury) offer solid background on structured settlement mechanics if you want to go deeper before talking to your attorney. For ongoing financial tracking during the case, a [medical expense and insurance claim workbook](https://www.amazon.com/s?k=medical+expense+tracking+workbook) can help you stay organized. (This site may earn a commission.)
...
In most states, yes. The legal standard is either "comparative negligence" or "contributory negligence" depending on where you are. Under comparative negligence, which most states use in some form, your damages get reduced by your percentage of fault. If you're found 20% responsible and damages total $1 million, you'd receive $800,000. A few states still use contributory negligence, which bars recovery entirely if you're even 1% at fault. Again, your state's rules matter enormously here.

### What if the at-fault party doesn't have enough insurance?

This is genuinely one of the hardest situations in catastrophic injury cases. A few options exist. If the defendant has personal assets beyond their policy limits, your attorney can pursue those directly. Your own underinsured motorist coverage, if you have it, may provide additional compensation in car accident cases. If multiple parties share liability, each may have their own coverage. In some cases, bankruptcy proceedings intersect with injury claims. There's rarely a clean solution when coverage is inadequate, which is exactly why reviewing your own insurance coverage before a crisis happens has real value.

### What does a catastrophic injury attorney actually cost?

Almost all personal injury attorneys, including those handling catastrophic cases, work on contingency. That means no upfront fees. They take a percentage of the recovery, typically 33% to 40% depending on whether the case settles or goes to trial, and state rules on fee caps. Case expenses, which can be substantial in catastrophic cases given the expert witnesses required, are usually advanced by the firm and reimbursed from the settlement. Make sure you understand the fee agreement before signing.

### Should I accept the insurance company's first offer?

In a catastrophic injury case? Almost certainly not. First offers in serious cases are routinely structured to close the claim before the full cost picture is established. I watched this happen from the inside for over a decade. The first offer is a starting point for negotiation, not a fair assessment. The only way to know whether any offer is reasonable is to have a complete damages analysis done first, which requires medical stabilization and expert review. A knowledgeable attorney will tell you immediately if an offer is even in the ballpark.
