---
title: "Pedestrian Hit by Car: 40% Don't Know Their Claim Rights"
date: 2026-07-25T12:10:39.213342+00:00
draft: false
description: "Learn what pedestrian injury claims typically cover, settlement ranges, and critical steps after being hit by a car."
image: "/img/heroes/18880069.jpg"
categories: ["Car Accidents"]
tags: ["pedestrian", "injury", "claim"]
...
slug: "pedestrian-hit-by-a-car-injury-claim"
affiliate_disclosure: true
faqs:
  - q: "How long do I have to file a pedestrian injury claim?"
    a: "It depends entirely on your state. Most states set a statute of limitations (the filing deadline) of 2 to 3 years from the date of the accident, but some are shorter. New York is currently 3 years for personal injury; Tennessee is 1 year. If the at-fault driver was a government vehicle (city bus, postal truck), notice deadlines can be as short as 90 days. Miss the deadline and your case is almost certainly dead."
  - q: "Should I accept the first settlement offer from the driver's insurance company?"
    a: "Rarely, and almost never without an attorney reviewing it first. First offers are typically low, and they're often made before your full injury picture is clear. Once you accept and sign a release, you're finished with that claim forever."
  - q: "What if the driver who hit me didn't have insurance?"
    a: "Your own uninsured motorist (UM) coverage steps in, if you have it. If you don't have a car, some states allow you to access a family member's UM policy. Beyond that, you can sue the driver personally, though collecting a judgment from someone who can't afford insurance is genuinely difficult and often produces little real money."
  - q: "Do I need a lawyer for a pedestrian injury claim?"
    a: "For anything beyond the most minor injuries, yes. Studies by the Insurance Research Council have consistently found that claimants represented by attorneys receive settlements roughly 3.5 times higher than unrepresented claimants, even after attorney fees. If your injuries are serious, trying to negotiate solo against an experienced adjuster is a significant disadvantage."
  - q: "Can I still recover damages if I was jaywalking when I was hit?"
    a: "In most states, yes, you can still recover, but your compensation will be reduced by your percentage of fault. The exception is the small number of states that still use pure contributory negligence, where any fault at all can theoretically bar recovery. An attorney in your state can tell you exactly which rules apply and what your realistic exposure is."
---

Roughly 7,500 pedestrians are killed by vehicles in the United States every single year. That number stopped me cold the [first time](/florida-raises-government-injury-caps-for-the-first-time-since-2010/) I really looked at it, because it works out to more than 20 people every day who went for a walk and didn't come home. And for every fatality, the National Highway Traffic Safety Administration (NHTSA) estimates there are somewhere around 8 to 10 serious injury survivors navigating hospital bills, lost wages, and an insurance system that was never designed to make their lives easier.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">State minimum auto liability limits for bodily injury (per person)</div><div class="sc-row"><span class="sc-label">Florida</span><span class="sc-track"><span class="sc-bar" style="width:20%"></span></span><span class="sc-val">$10,000</span></div><div class="sc-row"><span class="sc-label">California</span><span class="sc-track"><span class="sc-bar" style="width:30%"></span></span><span class="sc-val">$15,000</span></div><div class="sc-row"><span class="sc-label">Texas</span><span class="sc-track"><span class="sc-bar" style="width:60%"></span></span><span class="sc-val">$30,000</span></div><div class="sc-row"><span class="sc-label">New York</span><span class="sc-track"><span class="sc-bar" style="width:50%"></span></span><span class="sc-val">$25,000</span></div><div class="sc-row"><span class="sc-label">Michigan</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$50,000</span></div><div class="sc-src">Source: Insurance Information Institute, 2026</div></div>
...
Get a personal injury attorney consultation. Most work on contingency, meaning no upfront fee, they take a percentage (typically 33% pre-litigation, 40% if it goes to trial) of what they recover. The [Insurance Information Institute](https://www.iii.org/) and [Nolo's personal injury resources](https://www.nolo.com/legal-encyclopedia/personal-injury) both have solid, plain-language overviews of your rights that are worth reading before any meeting.

## Sources

- [NHTSA Traffic Safety Facts, Pedestrians](https://crashstats.nhtsa.dot.gov/): Annual data on pedestrian fatalities and injury rates; used for the 7,500 annual fatality figure and injury survivor ratios.
- [Insurance Information Institute (iii.org)](https://www.iii.org/): State minimum liability coverage data and auto insurance policy structure explanations.
- [Journal of Trauma and Acute Care Surgery (2023)](https://journals.lww.com/jtrauma/): Study on traumatic brain injury prevalence among hospitalized pedestrian crash survivors.
- [Nolo Personal Injury Legal Encyclopedia](https://www.nolo.com/legal-encyclopedia/personal-injury): Plain-language explanations of comparative fault, damages types, and state-by-state rules.
- [Insurance Research Council](https://www.insurance-research.org/): Data on uninsured and underinsured motorist claim trends and settlement patterns.

---


*Photo: [Bruno Brandao](https://www.pexels.com/@bruno-brandao-727244277) via Pexels*
