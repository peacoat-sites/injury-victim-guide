...
faqs:
  - q: "How is a personal injury settlement calculated?"
    a: "Settlements typically add up your economic damages — medical bills, lost wages, future medical costs — then multiply those by a 'pain and suffering' factor ranging from 1x to 20x depending on injury severity. The gross figure is then reduced by your percentage of fault and attorney fees."
  - q: "What is a pain and suffering multiplier?"
    a: "A multiplier is a number applied to your economic damages to estimate pain and suffering (non-economic) compensation. Minor soft-tissue injuries typically use 1–2.5x; catastrophic or permanently disabling injuries can use 10–20x or more."
  - q: "Does the at-fault percentage affect my settlement?"
    a: "Yes. In states with comparative negligence rules, your recovery is reduced by your share of fault. If a jury finds you 20% at fault, your total damages are reduced by 20%."
  - q: "How much do personal injury lawyers charge?"
    a: "Most personal injury attorneys work on contingency, meaning they take a percentage of your recovery — typically 33% if settled before trial, rising to 40% if the case goes to court."
---
...
These are general industry reference ranges, not guarantees. Some jurisdictions cap non-economic damages by statute — see our [state damage caps table](/state-damage-caps/) for details.
...
If you are unsure where to start, our guide on [how personal injury claims work](/posts/) walks through the full process from accident to settlement, including what insurance companies look for and the common mistakes that reduce payouts.
